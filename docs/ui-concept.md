...
- [Windows command bar](https://learn.microsoft.com/en-us/windows/apps/design/controls/command-bar), [settings guidance](https://learn.microsoft.com/en-us/windows/apps/design/app-settings/guidelines-for-app-settings), and [visual layout](https://learn.microsoft.com/en-us/windows/win32/uxguide/vis-layout): visible frequent controls, secondary settings, repeated alignment, and lightweight dividers informed the revised command strip.
